								...
								InputProps={{
									...
									endAdornment: (
										...
										<Tooltip title="Start the agent (minimum 6 characters). Data can be anything, and it will run based on your selected tools">
											<IconButton 
												type="submit"
												color={actionInput === undefined || actionInput === null || actionInput.length < 3  ? "secondary" : "primary"}
												disabled={actionInput === undefined || actionInput === null || actionInput.length < 3 }
											> 
												<SendIcon 
													color={actionInput === undefined || actionInput === null || actionInput.length < 3 ? "secondary" : "primary"}
												/>
